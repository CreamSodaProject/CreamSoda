package com.example.creamsoda.config;

import com.example.creamsoda.auth.JwtAuthorizationFilter;
import com.example.creamsoda.exception.Exception401;
import com.example.creamsoda.exception.Exception403;
import com.example.creamsoda.util.MyFilterResponseUtil;
...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable); // postman 으로 접근하기 위해 토큰을 비활성화 - csr 이용 , 반면에 ssr이라면 ?
