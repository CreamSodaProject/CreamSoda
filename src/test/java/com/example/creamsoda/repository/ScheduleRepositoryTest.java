...
public class ScheduleRepositoryTest {
    ...
    @BeforeEach
    public void init() {
        setup("프로젝트 세팅 마무리", "JPA 테스트는 다 마무리 해야함!", ScheduleLabel.RED,
    ...
    void ScheduleInsertAndDelete() {
        ...
        Schedule schedule = scheduleRepository.save(
                setup("풋살", "진짜 박살내기 ^^", ScheduleLabel.BLUE,
    ...
    public Schedule setup(String title, String memo, ScheduleLabel label, LocalDateTime startTime, LocalDateTime endTime) {
